<!-- crawl_url: https://signalk.org/specification/ -->
<!-- crawl_ts: 1787776850 -->
<!-- quality: sufficient -->
<!-- char_count: 4711 -->
<!-- word_count: 762 -->
...
This is the documentation for the[Signal K Specification](https://github.com/signalk/specification)1.8.2
version ([permalink](http://signalk.org/specification/1.8.2/doc/)).
...
![Gateway and Server setup](https://signalk.org/specification/gateway_and_server.png)
...
![Server only setup](https://signalk.org/specification/server_only.png)
...
JSON schema. See the[Signal K Data Model](https://signalk.org/specification/data_model.html)section for details.
...
The Signal K project has Open Source reference server implementations in[Node](https://github.com/SignalK/signalk-server-node)and[Java](https://github.com/SignalK/signalk-server-java).
There are also several web apps provided by the project which can be installed directly in the Node and Java servers or
downloaded from[Signal K GitHub](https://github.com/SignalK). There are also commercial[Signal K applications and solutions](http://signalk.org/applications_solutions.html), including mobile apps available
